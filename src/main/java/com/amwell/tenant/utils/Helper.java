...
public class Helper {
	...
	/**
	 * Get the element locator method and value for debugging purposes in the *Wait class methods
	 * No logging necessary as this is a helper method
	 *
	...
	public static String getElementLocator(WebElement element) {
		...
		String str = element.toString().substring(element.toString().indexOf("->") + 3);
	...
	/**
	 * Get the by locator method and value for debugging purposes in the *Wait class methods
	 * No logging necessary as this is a helper method
	 *
	 * @param by By locator
	 * @return String
	 */
	public static String getElementLocator(By by) {

		String str = by.toString().substring(by.toString().indexOf("By."));
